      ...
      <div id="wd-assignments">
        ...
        <ul id="wd-assignment-list">
          <li className="wd-assignment-list-item">
            <Link href="/Courses/1234/Assignments/001"
          ...
          <li className="wd-assignment-list-item">
            <Link href="/Courses/1234/Assignments/002" className="wd-assignment-link">
                A2 - CSS + BOOTSTRAP
            </Link> <br></br>
            Multiple Modules | <strong>Not available until</strong> 
          ...
          <li className="wd-assignment-list-item">
            <Link href="/Courses/1234/Assignments/003" className="wd-assignment-link">
                A3 - JAVASCRIPT + REACT
            </Link> <br></br>
            Multiple Modules | <strong>Not available until</strong> 
