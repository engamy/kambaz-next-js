...
export default function WorkingWithArrays() {
  ...
  return (
    <div id="wd-working-with-arrays" suppressHydrationWarning>
    ...
    <h4>Retrieving an Item from an Array by ID</h4>
      ...
      <a href={`${API}/${todo.id}/completed/${todo.completed}`} className="btn btn-primary float-end">
        Update Completed</a>
      <FormCheck type="checkbox" checked={todo.completed} className="w-50 float-start"
             onChange={(e) => setTodo({ ...todo, completed: e.target.checked }) } label="Completed" />
      <br /><br /><hr />
