   ...
   <Table striped>
    ...
    <tbody>
     ...
     <tr><td className="wd-full-name text-nowrap">
      ...
      <td className="wd-total-activity">12:30:18</td></tr>
     <tr><td className="wd-full-name text-nowrap">
          <FaUserCircle className="me-2 fs-1 text-secondary" />
      ...
      <td className="wd-total-activity">09:45:22</td></tr>
     <tr><td className="wd-full-name text-nowrap">
          <FaUserCircle className="me-2 fs-1 text-secondary" />
          <span className="wd-first-name">Ada</span>{" "}
          <span className="wd-last-name">Lovelace</span></td>
      <td className="wd-login-id">001234565S</td>
      <td className="wd-section">S101</td>
      <td className="wd-role">STUDENT</td>
      <td className="wd-last-activity">2020-10-05</td>
      <td className="wd-total-activity">11:20:15</td></tr>
     <tr><td className="wd-full-name text-nowrap">
          <FaUserCircle className="me-2 fs-1 text-secondary" />
          <span className="wd-first-name">Alice</span>{" "}
          <span className="wd-last-name">Wonderland</span></td>
      <td className="wd-login-id">001234566S</td>
      <td className="wd-section">S101</td>
      <td className="wd-role">STUDENT</td>
      <td className="wd-last-activity">2020-10-06</td>
      <td className="wd-total-activity">07:55:33</td></tr>
    </tbody>
   </Table>
  </div> );}